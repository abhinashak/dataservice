...
create table backups(
	...
	BACKUP_STATUS varchar(64) NOT NULL DEFAULT '',
	BACKUP_LOCATION varchar(255) NOT NULL DEFAULT '',
	BACKUP_SIZE INTEGER NOT NULL,
	LAST_BACKUP_START_TIME datetime DEFAULT NULL,
	LAST_BACKUP_END_TIME datetime DEFAULT NULL,
	LAST_UPLOAD_START_TIME datetime DEFAULT NULL,
	LAST_UPLOAD_END_TIME datetime DEFAULT NULL,
	COMPRESS_START_TIME datetime DEFAULT NULL,
	COMPRESS_END_TIME datetime DEFAULT NULL
	);
...
create table recovery(
	IP varchar(16) NOT NULL,
	PORT INTEGER NOT NULL,
	RECOVERY_STATUS varchar(64) NOT NULL DEFAULT '',
	LAST_RECOVERY_START_TIME datetime DEFAULT NULL,
	LAST_RECOVERY_END_TIME datetime DEFAULT NULL
	);
