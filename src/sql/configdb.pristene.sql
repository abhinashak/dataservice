...
('Y', 'I', 'ADD_BACKUP_DETAIL', 'insert into backups(IP, PORT, BACKUP_STATUS, BACKUP_LOCATION, BACKUP_SIZE, BACKUP_START_TIME, BACKUP_END_TIME, UPLOAD_START_TIME, COMPRESS_START_TIME, COMPRESS_END_TIME) values (?,?,?,?,?,?,?,?,?,?)','' ),
('Y', 'U', 'UPDATE_BACKUP_STATUS', 'update backups set BACKUP_STATUS=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_BACKUP_LOCATION', 'update backups set BACKUP_LOCATION=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_BACKUP_SIZE', 'update backups set BACKUP_SIZE=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_LAST_BACKUP_START_TIME', 'update backups set LAST_BACKUP_START_TIME=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_LAST_BACKUP_END_TIME', 'update backups set LAST_BACKUP_END_TIME=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_LAST_UPLOAD_START_TIME', 'update backups set LAST_UPLOAD_START_TIME=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_LAST_UPLOAD_END_TIME', 'update backups set LAST_UPLOAD_END_TIME=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_COMPRESS_START_TIME', 'update backups set COMPRESS_START_TIME=? where IP=? AND PORT=?','' ),
('Y', 'U', 'UPDATE_COMPRESS_END_TIME', 'update backups set COMPRESS_END_TIME=? where IP=? AND PORT=?','' );
