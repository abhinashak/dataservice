...
public class DataserviceConstants {
	...
	public final static Configuration conf = DataserviceConfiguration.getInstance().getConfiguration();
	...
	public final static String AUTHENTICATOR_CLASS = 
		conf.get("authenticator.class.name","com.bizosys.dataservice.authorization.BlackholeAuthenticator");

	public final static String AUTHORIZATION_CLASS = 
			conf.get("authoriztion.class.name","com.bizosys.dataservice.authorization.BlackholeAuthorizer");
	...
	public static final String adminPwdHash = Hash.createHex(DataserviceConstants.ENCRYPTION_KEY, "1et'$dance");
