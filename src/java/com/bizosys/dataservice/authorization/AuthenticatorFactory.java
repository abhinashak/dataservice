...
public class AuthenticatorFactory {
	...
	public IAuthenticate getAuthenticatorImpl() throws CreateException {
		...
		synchronized (IAuthenticate.class.getName()) {
			if ( null != authenticatorImplInstance ) return authenticatorImplInstance;
			try {
				LOG.info("Initializing the authenticator module :" + DataserviceConstants.AUTHENTICATOR_CLASS);
				Object authenticatorImplInstanceO = Class.forName(DataserviceConstants.AUTHENTICATOR_CLASS).newInstance();
				...
				LOG.fatal(e);
				throw new CreateException("Unable to crate the authenticator : " + DataserviceConstants.AUTHENTICATOR_CLASS);
			} 
